        ...
        <div id="site-header__logo">
          <a href="#home-hero" aria-label="Ardhiansyah">
            <svg width="48" height="28" viewBox="0 0 48 28" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 24L16 4L24 24H20.5L18.5 18H13.5L11.5 24H8ZM14.5 15H17.5L16 9L14.5 15Z" fill="#00FFAA" />
              <path d="M26 4H34C36.2 4 38 4.8 39.2 6.2C40.4 7.6 40.8 9.2 40.8 11C40.8 13.2 40 15 38.4 16.2L42 24H37.5L34.4 17H30V24H26V4ZM30 14H33.5C35 14 36.2 13 36.2 11C36.2 9 35 8 33.5 8H30V14Z" fill="#00FFAA" />
            </svg>
          </a>
        </div>
        <a
